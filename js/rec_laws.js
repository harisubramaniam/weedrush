...
function getFactsByState() {
    ...
    $.each(rec_laws_by_state_data, function() {
        ...
        if(selected_state == loop_state) {
          ...
          rec_facts += "<div class=\"col-xs-8\" style=\"background-color: #CBD4C0\">Who can posess:</div><div class=\"col-xs-4\" style=\"background-color: #CBD4C0\"> " + rec_laws_by_state_data[count]["who_can_posess"] + "</div></div>";
          rec_facts += "<div class=\"row\" style=\"padding:5px\">";
          ...
          rec_facts += "<div class=\"row\" style=\"padding:5px\">";
          rec_facts += "<div class=\"col-xs-8\" style=\"background-color: #CBD4C0\">Retail purchase:</div><div class=\"col-xs-4\" style=\"background-color: #CBD4C0\"> " + rec_laws_by_state_data[count]["retail_sale"] + "</div></div>";
          rec_facts += "<div class=\"row\" style=\"padding:5px\">";
          rec_facts += "<div class=\"col-xs-8\">Home growing:</div><div class=\"col-xs-4\"> " + rec_laws_by_state_data[count]["home_grow"] + "</div></div>";
          rec_facts += "<div class=\"row\" style=\"padding:5px\">";
          rec_facts += "<div class=\"col-xs-8\" style=\"background-color: #CBD4C0\">Use in public:</div><div class=\"col-xs-4\" style=\"background-color: #CBD4C0\"> " + rec_laws_by_state_data[count]["public_use"] + "</div></div>";
        } 
        count++;
