...
function getFactsByState() {
    ...
    $.each(duid_laws_data, function() {
        ...
        if(selected_state == loop_state) {
          ...
          laws += "<div class=\"col-xs-8\" style=\"background-color: #CBD4C0\">Section of the Criminal Code:</div><div class=\"col-xs-4\" style=\"background-color: #CBD4C0\"> " + duid_laws_data[count]["criminal_code"] + "</div></div>";
          laws += "<div class=\"row\" style=\"padding:5px\">";
          laws += "<div class=\"col-xs-8\">Under the Influence Law:</div><div class=\"col-xs-4\"> " + duid_laws_data[count]["DUID_law"] + "</div></div>";
          laws += "<div class=\"row\" style=\"padding:5px\">";
          laws += "<div class=\"col-xs-8\" style=\"background-color: #CBD4C0\">Sentencing for first offense:</div><div class=\"col-xs-4\" style=\"background-color: #CBD4C0\"> " + duid_laws_data[count]["sentencing"] + "</div></div>";
          laws += "<div class=\"row\" style=\"padding:5px\">";
          laws += "<div class=\"col-xs-8\">Fine for first offense:</div><div class=\"col-xs-4\"> " + duid_laws_data[count]["fine"] + "</div></div>";
          laws += "<div class=\"row\" style=\"padding:5px\">";
          laws += "<div class=\"col-xs-8\" style=\"background-color: #CBD4C0\">Driver's license suspension for first offense:</div><div class=\"col-xs-4\" style=\"background-color: #CBD4C0\"> " + duid_laws_data[count]["dl_suspension"] + "</div></div>";
          laws += "<div class=\"row\" style=\"padding:5px\">";
